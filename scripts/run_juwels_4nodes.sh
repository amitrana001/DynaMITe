...
#SBATCH --output=/p/project/objectsegvideo/sabari/code/InteractiveM2F/run_scripts/dynamite_coco_4gpus_1024_%A_%a.log


echo "Activating conda env and project..."
jutil env activate -p objectsegvideo

source /p/project/paj2209/sabari_libs/anaconda3/bin/activate m2f
