...
from dynamite.data.points.annotation_generator import gen_multi_points_per_mask
...
__all__ = ["COCOMultiInstStuffMultiQueriesClicksDatasetMapper"]

# This is specifically designed for the COCO dataset.
class COCOMultiInstStuffMultiQueriesClicksDatasetMapper:
    """
