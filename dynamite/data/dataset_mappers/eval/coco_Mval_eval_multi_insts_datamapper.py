...
from dynamite.data.points.annotation_generator import generate_point_to_blob_masks_eval, generate_point_to_blob_masks_eval_deterministic

__all__ = ["COCOMvalMultiInstsDatasetMapper"]

# This is specifically designed for the COCO dataset.
class COCOMvalMultiInstsDatasetMapper:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        coco_mval_ids = [int(img_id.split("_")[-1][:-4]) for img_id in coco_mval_images]
        ...
        if "annotations" in dataset_dict:
            ...
            instances = filter_instances(instances, min_area = 1000.0)
