# Adapted from https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/modeling/pixel_decoder/msdeformattn.py
import logging
import numpy as np
...
from ..interactive_transformer.transformer import _get_clones, _get_activation_fn
