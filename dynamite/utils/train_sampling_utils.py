...
def get_next_clicks(targets, pred_output, timestamp, device, scribbles = None, batched_num_scrbs_per_mask=None,
...
def _get_corrective_clicks(pred_mask, gt_mask, semantic_map, padding_mask,timestamp,
