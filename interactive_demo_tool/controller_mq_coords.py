...
class InteractiveController:
    ...
    def add_click(self, x, y, bg_click =False, inst_num=1):
        ...
        if bg_click:
            ...
            if not self.batched_fg_coords_list:
            ...
            elif inst_num <= len(self.batched_num_scrbs_per_mask[0]):
        ...
        if self.features is None:
            ...
            self.multi_scale_features,
            self.batched_num_scrbs_per_mask, self.batched_fg_coords_list,
            self.batched_bg_coords_list) = self.predictor(inputs, self.images, self.num_insts,
