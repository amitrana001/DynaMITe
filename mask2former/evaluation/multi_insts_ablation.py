...
def get_avg_noc(
    ...
    with ExitStack() as stack:
        ...
        failed_objects_areas = [0] * 201 #binning the object area
        bin_size = 200
        ...
        for idx, inputs in enumerate(data_loader):
            ...
            processed_results= model(inputs)
    ...
    stats_file = os.path.join(save_summary_path, f"{model_name}_{max_interactions}_summary_stats.pickle")
