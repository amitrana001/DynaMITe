...
def add_maskformer2_config(cfg):
    ...
    cfg.ITERATIVE.TRAIN.UNIQUE_TIMESTAMP = False
    cfg.ITERATIVE.TRAIN.CONCAT_XYT = False
    cfg.ITERATIVE.TRAIN.USE_ONLY_TIME = False
    ...
    cfg.ITERATIVE.TRAIN.USE_POINT_FEATURES = False
    cfg.ITERATIVE.TRAIN.USE_COORDS_ON_POINT_MASKS = False
    cfg.ITERATIVE.TRAIN.USE_ARGMAX = False
