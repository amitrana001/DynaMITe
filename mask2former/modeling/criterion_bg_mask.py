...
from criterion import dice_loss_jit, sigmoid_ce_loss_jit, calculate_uncertainty, CRITERION_REGISTRY

@CRITERION_REGISTRY.register()
class RegressBgMask(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks, bg_loss = True):
