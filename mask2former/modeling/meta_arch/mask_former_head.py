...
class MaskFormerHead(nn.Module):
    ...
    def forward(self, features, mask=None, scribbles=None):
        # print("Scribbles:",scribbles.shape)
        return self.layers(features, mask, scribbles = scribbles)

    def layers(self, features, mask=None, scribbles=None):
