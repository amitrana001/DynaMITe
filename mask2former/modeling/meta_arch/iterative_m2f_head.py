...
class IterativeM2FHead(nn.Module):
    ...
    def layers(self, data, targets, images, features, num_instances, mask=None, scribbles=None,
        ...
        if self.transformer_in_feature == "multi_scale_pixel_decoder":
            ...
            predictions = self.predictor(data, targets, images, num_instances, multi_scale_features,
        ...
        if self.training:
            ...
            return predictions, mask_features, transformer_encoder_features, multi_scale_features