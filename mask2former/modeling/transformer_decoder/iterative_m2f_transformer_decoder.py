...
class IterativeM2FTransformerDecoder(nn.Module):
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["use_multiclass_softmax"] = cfg.ITERATIVE.TRAIN.USE_MULTICLASS_SOFTMAX
        # Iterative Pipeline
        ...
        if self.training:
            if self.accumulate_loss:
                ...
                for _ in range(num_iters):
                    prev_output = self.iterative_batch_forward(x, src, pos, size_list, mask_features, scribbles, prev_mask_logits)
