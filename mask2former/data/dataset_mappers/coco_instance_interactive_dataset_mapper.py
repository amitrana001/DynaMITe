...
__all__ = ["COCOInstanceInteractiveDatasetMapper"]
...
class COCOInstanceInteractiveDatasetMapper:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            if hasattr(instances, 'gt_masks'):
                ...
                dataset_dict["bg_scrbs"] = get_scribble_gt_mask(np.asarray(all_masks).astype(np.uint8)*255, bg = True)
