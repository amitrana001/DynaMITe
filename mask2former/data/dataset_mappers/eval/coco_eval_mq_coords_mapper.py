...
from mask2former.data.dataset_mappers.mapper_utils.datamapper_utils import convert_coco_poly_to_mask,  build_transform_gen

from mask2former.evaluation.eval_utils import get_gt_clicks_coords_eval

__all__ = ["COCOEvalMQCoordsMapper"]

# This is specifically designed for the COCO dataset.
class COCOEvalMQCoordsMapper:
    """
