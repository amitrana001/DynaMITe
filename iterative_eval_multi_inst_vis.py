...
class Trainer(DefaultTrainer):
    ...
    def test(cls, cfg, model, evaluators=None):
        ...
        if eval_strategy in ["random", "best", "worst"]:
            from mask2former.inference.random_best_worst_vis import evaluate
        ...
        for idx,dataset_name in enumerate(["coco_2017_val"]):
            ...
            results_i = evaluate(model, data_loader,cfg, dataset_name, sampling_strategy=1,
                                iou_threshold = 1.1, max_interactions = 10,
